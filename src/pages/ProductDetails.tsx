    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden pb-24 bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-text-primary antialiased">
      ...
      <div className="relative w-full h-[45vh] shrink-0">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuA_HGU9JFYRKXK08NWASIZ89YjKwgmlMOXu_aCWCA6vcUSfo8NsL8mFRSWAe3s7QGksE6O-rFRJgleur4I8b6EmpNNR0iblPvyGJW3pMsCavXt12-8i5vV0cOhYnLqhAeoP9KC88Lzn1bn-I9nHQX3jVEGJ7xjHpximnooeY-HV8LpEvMc_6QRlh2psuuaqp4NTUOWH2k2np-x4ZCXrjWf-6KOJoZQQENYAIubRhExwd3fqXKtcrcDq8Yr26hqtcwy_Z-6IobDQMw')`,
          }}
        ></div>
        {/* Gradient Overlay */}
        ...
        <div className="flex flex-col gap-1 pb-4">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex shrink-0 items-center rounded-lg bg-primary/10 px-3 py-1">
              <span className="text-xl font-bold text-primary">R$ 6,00</span>
            </div>
          </div>
          {/* Ratings */}
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-slate-200 bg-background-light/80 px-4 py-4 backdrop-blur-md dark:border-slate-800 dark:bg-background-dark/90">
        <button className="flex h-14 w-full cursor-pointer items-center justify-between rounded-xl bg-primary px-6 text-base font-bold text-white shadow-lg shadow-primary/25 transition-transform active:scale-[0.98]">
