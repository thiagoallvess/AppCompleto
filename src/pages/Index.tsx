      ...
      <main className="max-w-md mx-auto flex flex-col gap-6 p-4">
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="@container">
            <div className="flex flex-col sm:flex-row items-stretch rounded-xl bg-white dark:bg-surface-dark shadow-sm overflow-hidden border border-gray-100 dark:border-gray-800 transition-all hover:shadow-md">
              <div
