        ...
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm font-bold text-slate-900 dark:text-white leading-none">Carlos Motoboy</span>
            </div>
          </div>
              ...
              <div className="p-4 pt-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center h-12 rounded-xl bg-primary text-[#102216] text-sm font-bold hover:brightness-110 transition-all shadow-[0_0_15px_rgba(19,236,91,0.2)]"
                  >
                    ACEITAR CORRIDA
                  </button>
                </div>
