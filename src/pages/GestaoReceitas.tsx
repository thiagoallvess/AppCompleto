...
const GestaoReceitas = () => {
  ...
  const recipes = [
    ...
    },
    {
      id: 5,
      name: "Coco Cremoso",
      image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAeVtLOwl0ATHwAcr5evKM61DHAzU3inwhcs4GPvoixzz3p2eVQDH15vlpPh1SxVPsVdfJplYcnPfPsFyxrPsMEUYJe1hmtSUBwCFaxW9qyQDi9eQ8SPaheHFgn_Jcv74p4y09O3_9AyQC6J6Wx_F4F0sU0nGdtYSVifLmIxEakMChIdi_AmMLmZsgw2qR4SrkeHv9d9IbFuXS4Y6oOH6X30vjrWZtU0k1HisnnJQJreG3UCI-4Jki6V311UN-RlFRTdfc18QWWlQ",
      time: "35 min",
      quantity: 22,
      cost: 1.15
    }
    ...
    <div className="bg-background-light dark:bg-background-dark font-display antialiased text-slate-900 dark:text-white pb-24 min-h-screen">
      ...
      <header className="sticky top-0 z-50 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="text-lg font-bold leading-tight tracking-tight flex-1 text-center pr-2">Gestão de Receitas</h1>
          <Link
            to="/add-receita"
