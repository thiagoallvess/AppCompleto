      ...
      <main className="flex-1 px-4 pb-24 pt-2 max-w-md mx-auto lg:max-w-7xl">
        <div className="flex flex-col gap-4">
          {orders.map((order) => (
            <article
              key={order.id}
              className={`group relative overflow-hidden rounded-xl bg-white dark:bg-surface-dark border border-gray-200 dark:border-gray-700 p-4 transition-all hover:border-primary/50 dark:hover:border-primary/50 ${
