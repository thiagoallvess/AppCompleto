import { ArrowLeft, Search, Home, Briefcase, MapPin, Edit, Circle, Delete, Plus, History } from "lucide-react";
...
const Enderecos = () => {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display antialiased text-slate-900 dark:text-white pb-24 min-h-screen">
      {/* Header */}
      <header className="sticky top-0 z-10 flex items-center justify-between bg-background-light dark:bg-background-dark p-4 pb-2 backdrop-blur-md bg-opacity-95 dark:bg-opacity-95 border-b border-gray-200 dark:border-gray-800 max-w-7xl mx-auto lg:px-6">
        <Link
          to="/perfil"
      ...
      {/* Main Content */}
      <main className="flex flex-col px-4 pt-4 gap-4 max-w-7xl mx-auto lg:px-6">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-background-light via-background-light to-transparent dark:from-background-dark dark:via-background-dark pt-8 max-w-7xl mx-auto">
        <Link to="/add-endereco">
