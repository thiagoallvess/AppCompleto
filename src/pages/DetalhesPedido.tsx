...
const DetalhesPedido = () => {
  return (
    <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden pb-6 bg-background-light dark:bg-background-dark">
      ...
      <main className="flex-1 px-4 py-6 space-y-6 pb-32 w-full max-w-4xl mx-auto">
        ...
        <div className="rounded-2xl bg-white dark:bg-surface-dark p-5 border border-slate-200 dark:border-slate-800 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Criado há 15 min</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">3x R$ 8,00</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="size-12 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0 text-slate-400">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">2x R$ 8,00</p>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-2xl bg-white dark:bg-surface-dark p-5 border border-slate-200 dark:border-slate-800 shadow-sm">
          ...
          <div className="relative pl-4 border-l-2 border-slate-200 dark:border-slate-800 space-y-6">
            ...
            <div className="relative">
              <div className="absolute -left-[21px] top-1 size-3 rounded-full bg-slate-300 dark:bg-slate-600 ring-4 ring-white dark:ring-surface-dark"></div>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Em Preparo</p>
              <p className="text-slate-500 dark:text-slate-400 text-xs">Aguardando...</p>
            </div>
            <div className="relative">
              <div className="absolute -left-[21px] top-1 size-3 rounded-full bg-slate-300 dark:bg-slate-600 ring-4 ring-white dark:ring-surface-dark"></div>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Saiu para Entrega</p>
              <p className="text-slate-500 dark:text-slate-400 text-xs">Aguardando...</p>
            </div>
          </div>
        </div>
      ...
      {/* Bottom Action */}
      <div className="fixed bottom-0 left-0 right-0 z-30 w-full border-t border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-surface-dark/95 backdrop-blur-md p-4 pb-safe">
